...
$searchUrl = !isset($searchUrl) ? Url::to(["citizenship/search"]) : $searchUrl;
$exclude = !isset($exclude) ? array() : $exclude;

if ($searchModel) {
    TableSearchAsset::register($this);
    $form = ActiveForm::begin([
        'id'          => 'citizenship-search-form',
        "action"      => $searchUrl,
        "options"     => [
            'clientValidation' => false,
            "class"            => "animated-label table-search-form",
            "data"             => [
                'target-table' => '#citizenship-search-table'
            ]
        ],
...
<table class="table table-bordered citizenship-table" id="citizenship-search-table">
    <thead>
    <?php if ($searchModel): ?>
