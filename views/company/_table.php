...
$searchUrl = !isset($searchUrl) ? Url::to(["company/search"]) : $searchUrl;
...
if ($searchModel) {
    ...
    $form = ActiveForm::begin([
        ...
        "options"     => [
            ...
            "data"             => [
                'target-table' => '#company-search-table'
            ]
        ],
...
<table class="table table-bordered company-table" id="company-search-table">
    <thead>
    <?php if ($searchModel): ?>
