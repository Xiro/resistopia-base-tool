...
/* @var $searchModel AccessCategorySearch */
/* @var $searchUrl string */
/* @var $exclude array */

$form = null;
$searchModel = !isset($searchModel) ? null : $searchModel;
$searchUrl = !isset($searchUrl) ? Url::to(["access-category/search"]) : $searchUrl;
...
if ($searchModel) {
    ...
    $form = ActiveForm::begin([
        'id'          => 'access-category-search-form',
        "action"      => $searchUrl,
        "options"     => [
            'clientValidation' => false,
            "class"            => "animated-label table-search-form",
            "data"             => [
                'target-table' => '#access-category-search-table'
            ]
        ],
...
<table class="table table-bordered sortable access-category-table" id="access-category-search-table" data-sortable-update="<?=Url::to(['access-category/update-order']) ?>">
    <thead>
    <?php if ($searchModel): ?>
