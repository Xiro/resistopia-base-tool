...
/* @var $searchModel AccessMaskSearch */
/* @var $searchUrl string */
/* @var $exclude array */

$form = null;
$searchModel = !isset($searchModel) ? null : $searchModel;
$searchUrl = !isset($searchUrl) ? Url::to(["access-mask/search"]) : $searchUrl;
$exclude = !isset($exclude) ? array() : $exclude;

if ($searchModel) {
    TableSearchAsset::register($this);
    $form = ActiveForm::begin([
        'id'          => 'access-mask-search-form',
        "action"      => $searchUrl,
        "options"     => [
            'clientValidation' => false,
            "class"            => "animated-label table-search-form",
            "data"             => [
                'target-table' => '#access-mask-search-table'
            ]
        ],
...
<table class="table table-bordered access-mask-table" id="access-mask-search-table">
    <thead>
    <?php if ($searchModel): ?>
        ...
        <tr class="animated-label">
            ...
            <?php if (!in_array("protected", $exclude)): ?>
                <?php $excludeSearchParams[] = "protected"; ?>
                <th class="protected">
    ...
    <?php else: ?>
        <tr>
            ...
            <?php endif; ?>
            <?php if (!in_array("protected", $exclude)): ?>
                <th class="protected"><?= 'Protected' ?></th>
            <?php endif; ?>
            <?php if (!in_array("actions", $exclude)): ?>
                <th></th>
            <?php endif; ?>
